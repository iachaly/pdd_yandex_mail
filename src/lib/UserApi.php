...
class Yandex_Mail_UserApi extends Yandex_Mail_Api_Base
{
    ...
    public function userOauthToken($domain,$login)
    {
        return $this->invokeHandler('api/user_oauth_token',
            array('domain' => $domain,'login' => $login)
        );
    }
     ...
     * @return SimpleXMLElement
     */
    public function editUserDetails($login, $new_password = null, $first_name = null, $last_name = null, $sex = null, $hintq = null, $hinta = null)
    {
